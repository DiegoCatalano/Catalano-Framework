...
/**
 * Binary Top-hat operator from Mathematical Morphology.
 * <br /> Binary Top-hat morphological operator subtracts result of morphological opening on the input image from the input image itself.
 ...
 */
public class BinaryTopHat implements IApplyInPlace{
    private int[][] kernel;
    private int radius;
     ...
     * @param radius Radius.
     */
    public BinaryTopHat(int radius) {

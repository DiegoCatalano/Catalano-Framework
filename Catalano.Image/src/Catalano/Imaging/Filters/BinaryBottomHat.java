...
/**
 * Binary Bottom-hat operator from Mathematical Morphology. 
 * <br /> Binary Bottom-hat morphological operator subtracts input image from the result of morphological closing on the the input image.
 ...
 */
public class BinaryBottomHat implements IApplyInPlace{
    private int[][] kernel;
    private int radius;
     ...
     * @param radius Radius.
     */
    public BinaryBottomHat(int radius) {
